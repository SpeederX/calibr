...
- `logs/action-trace.jsonl` under the calibr data directory: what the user tried to do and how calibr handled it.

When opening an issue, attach both files when possible. Doctor explains the machine; the trace explains the attempted flow.
